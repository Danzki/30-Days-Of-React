...
const options = [
  ...
  const App = (props) => {
    ...
    const validate = () => {
      ...
      //email
      if (formData.touched.email && !formData.email.includes('@') && !formData.email.includes('.')) {
        errors.email = 'Incorrect email'
      }
  
      //tel
      if (formData.touched.tel && formData.tel.length < 5) {
        errors.tel = 'Incorrect telephone'
      }
  
      //dateOfBirth
      if (formData.touched.dateOfBirth && formData.dateOfBirth === '') {
